...
export default function App() {
  ...
  // プリセット/モード名変更時にMedia Sessionメタデータを更新
  useEffect(() => {
    if (engine.isInitialized && presets.currentConfig.name) {
      engine.updateModeName(presets.currentConfig.name);
    }
  }, [presets.currentConfig.name, engine.isInitialized, engine]);
